...
Other uses a number of open source projects to work properly:
...
* [Express] - fast node.js network app framework [@something]
...
```sh
cd dillinger
docker build -t xivig/xivig:${package.json.version} .
```
This will create the xivig image and pull in the necessary dependencies. Be sure to swap out `${package.json.version}` with the actual version of xivig.

Once done, run the Docker image and map the port to whatever you wish on your host. In this example, we simply map port 8000 of the host to port 8080 of the Docker (or whatever port was exposed in the Dockerfile):

```sh
docker run -d -p 8000:8080 --restart="always" <youruser>/xivig:${package.json.version}
```
...
See [KUBERNETES.md](https://github.com/xivig/xivig/blob/master/KUBERNETES.md)
